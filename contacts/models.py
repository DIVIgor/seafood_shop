    ...
    contact_info = StreamField([
        ('info', blocks.StreamBlock(
            [
                ...
                ], block_counts={'string': {'min_num': 7, 'max_num': 7}}, icon='date')),
                ('address', blocks.StructBlock([
                    ('address_upper', blocks.CharBlock(max_length=250)),
                    ('address_lower', blocks.CharBlock(required=False, max_length=250)),
                ], icon='home')),
                ('contacts', blocks.StructBlock([
                    ('short_message', blocks.CharBlock(required=False, max_length=250)),
                    ('phone', blocks.CharBlock(required=False, max_length=15)),
                    ('email', blocks.CharBlock(required=False, max_length=250)),
                ], icon='mail'))
